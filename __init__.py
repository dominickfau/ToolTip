...
class Tooltip:
    ...
    Args:
        widget (Tkinter Widget): The tkinter widget for the tooltip.
        text (string): Text to show in the tooltip.
        bg (string, optional): Hex color value for the tooltip background. Defaults to #e5e5e5.
        pad (tuple, optional): A tuple of 4 int. Used to pad the tooltip text. Defaults to (5, 3, 5, 3).
        waitTime (int, optional): The time in milliseconds before showing the tooltip. Defaults to 350
        wrapLength (int, optional): Wordwrap length of the text, set in pixels. Defaults to 250.
    """
